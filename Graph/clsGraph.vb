...
#Region "Member Vars"
            Protected mvpPayload As VertexPayload
            Protected mlngVertexID As Long
            Protected mlstEdges As List(Of Long)
#End Region
...
#Region "MemberVars"
            Protected mepPayload As EdgePayload
            Protected mlngEdgeID As Long
            Protected mlngVertexID1 As Long
            Protected mlngVertexID2 As Long
#End Region
...
#Region "Public Functionality"
        ...
        Public Function GetVertex(ByVal plngID As Long) As clsVertex(Of GraphVertexPayload)
        ...
        Public Function GetEdge(ByVal plngID As Long) As clsEdge(Of GraphEdgePayload)
        ...
        Public Function AddNewVertex(Optional ByRef pvpPayload As GraphVertexPayload = Nothing) As Long
        ...
        Public Sub RemoveVertex(ByVal plngVertexID As Long, Optional ByVal pblnRemoveAttachedEdges As Boolean = True)
